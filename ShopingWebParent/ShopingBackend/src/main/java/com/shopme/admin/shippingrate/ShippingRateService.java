...
public class ShippingRateService {
	...
	public void save(ShippingRate rateInForm) throws ShipingRateAlreadyException {
		...
		if (foundExistingRateInNewMode || foundDifferentExistingRateInEditMode) {
			throw new ShipingRateAlreadyException("There's already a rate for the destination "
	...
	public void updateCODSupport(Integer id, boolean codSupported) throws ShipingRateNotFoundException {
